...
## Table des Matières
- [Technologies Utilisées](#ttechnologies-utilisées)
...
Après avoir ajouté les Dockerfiles pour le client et le serveur, ainsi que les captures d'écran dans le dossier racine, voici les étapes pour construire les images et gérer l'application avec Docker Compose :
...
![Lancement de Jenkins](./Lancer%20Jenkins.png)
